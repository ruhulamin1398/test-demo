...
// Type definition for phone number and country code
interface Phone {
  countryCode: string;
  number: string;
}
...
const RegistrationForm: React.FC = () => {
  ...
  const [register, { data, error, loading }] =
  ...
  useEffect(() => {
    if (data?.createUser?.user) {
      ...
      router.push("/");
      notify({ severity: "success", message: "Successfully created account!" });
      ...
      >
        {({ setFieldValue, errors, touched, values, setFieldTouched }) => (
          <Form>
                ...
                <Field
                  ...
                  sx={{
                    "& input:-webkit-autofill": {
                      backgroundColor: "transparent !important", // Remove autofill background
                      boxShadow: "none !important",
                    },
                    "& input:-webkit-autofill:focus": {
                      backgroundColor: "transparent !important", // Ensure autofill stays removed on focus
                    },
                  }}
                />
              </Grid>
            ...
            <Field name="phoneNumber.countryCode">
              {({ field, form }: any) => (
                <Autocomplete
                  {...field}
                  value={
                    countries.find(
                      (option) => option.code === values.phoneNumber.countryCode
                    ) || null
                  }
                  onChange={(_, value: CountryType) => {
                    if (value) {
                      setFieldValue("phoneNumber.countryCode", value.code);
                    }
                  }}
                  onBlur={() => {
                    setFieldTouched("phoneNumber.countryCode", true);
                  }}
                  options={countries}
                  ...
                  renderInput={(params) => (
                    <TextField
                      ...
                      helperText={
                        ...
                        touched.phoneNumber?.countryCode
                          ? errors.phoneNumber?.countryCode
                          : ""
                      }
                      error={
            ...
            <Field
              ...
              margin="normal"
              helperText={
                errors.phoneNumber?.number && touched.phoneNumber?.number
...
function notify(arg0: { severity: string; message: string }) {
