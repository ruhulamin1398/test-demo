...
import CompetitionFilterTab from "../molecules/CompetitionFilterTab";
...
const CompetitionGridInfiniteScroll: React.FC = () => {
...
export default CompetitionGridInfiniteScroll;
