...
const useUtilityClasses = (
  ...
  const slots = {
    ...
    rangeIntervalPreview: [
      ...
      (isDayPreviewStart || isDayStartOfMonth) &&
  ...
  variants: [
    ...
    },
    {
      props: ({
        ...
        isDayPreviewed &&
        !isDayFillerCell &&
        (isDayPreviewStart || isDayFirstVisibleCell),
      style: {
        borderLeftColor: (theme.vars || theme).palette.divider,
        ...startBorderStyle,
      },
    },
    {
      props: ({
        ...
        isDayPreviewed &&
        !isDayFillerCell &&
        (isDayPreviewEnd || isDayLastVisibleCell),
      style: {
        borderRightColor: (theme.vars || theme).palette.divider,
        ...endBorderStyle,
      },
...
const DateRangePickerDayDay = styled(PickersDay, {
  ...
  props: PickersDayProps & { ownerState: DateRangePickerDayOwnerState }
) => React.JSX.Element;
...
const DateRangePickerDayRaw = React.forwardRef(function DateRangePickerDay(
  ...
  const ownerState: DateRangePickerDayOwnerState = {
    ...
    isDayInsidePreview:
      isPreviewing && !isStartOfPreviewing && !isEndOfPreviewing,
