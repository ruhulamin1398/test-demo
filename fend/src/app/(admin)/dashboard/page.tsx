     ...
     {(latestSuper>-1) && <JackPotCards
      ...
      >
        ...
        <ShowEarningCard className="main-gradient"
          ...
          referralCommission={(isNaN(user?.premiumReferralRewards) ? 0 : user?.premiumReferralRewards) +        (isNaN(referralInfo?.totalReferredAmount) ? 0 : referralInfo?.totalReferredAmount) || "0.00"}
